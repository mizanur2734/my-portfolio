  ...
  return (
    ...
    >
      ...
      <div data-aos="fade-down-right" className="text-left mt-20 md:mt-0">
        ...
        <p data-aos="zoom-in" className="text-white mb-2 md:text-xl">
          Hello! I’m Mizanur Malita, a passionate web developer who loves
          turning ideas into interactive and user-friendly web experiences.
          Using React, Tailwind CSS, and modern web technologies, I create
          clean, responsive, and user-friendly interfaces.{" "}
        </p>
        <p data-aos="zoom-in" className="text-white mb-2 md:text-xl">
          Outside of coding, I enjoy exploring new technologies, reading books,
          and playing cricket. These hobbies keep me creative, motivated, and
          ready to bring fresh ideas into my work.{" "}
        </p>
        <p data-aos="zoom-in" className="text-white mb-4 md:text-xl">
          I’m not just a developer — I’m a lifelong learner, a creative problem
          solver, and see every project as an opportunity to learn and inspire.
        </p>
