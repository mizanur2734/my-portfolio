...
const Services = () => {
    return (
        <div id='service' className="min-h-screen text-white flex flex-col items-center justify-center mt-12 md:mt:2">
            <h2 className="text-4xl font-bold mb-12">My <span className='text-[#0ef]'>Services</span></h2>
            {/* card 1 */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-[#101a2a] p-8 rounded-2xl shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/100 transition duration-300 text-center w-80">
                    ...
                    <button className='btn-box-hover px-4 py-2 bg-[#0ef] rounded-4xl text-black'>Loren More</button>
                </div>
